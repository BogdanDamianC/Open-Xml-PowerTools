...
namespace OpenXmlPowerTools.HtmlToWml
{
    ...
    public class HtmlToWmlConverterCore
    {
        ...
        {
            return ConvertHtmlToWml(defaultCss, authorCss, userCss, bodyxhtml, null, settings, emptyDocument, annotatedHtmlDumpFileName);
        }
        ...
        public static WmlDocument ConvertHtmlToWml(
                   ...
                   string userCss,
                   XElement bodyxhtml,
                   IEnumerable<HeaderFooterContent> headerFooterContent,
                   HtmlToWmlConverterSettings settings,
                   WmlDocument emptyDocument,
                   string annotatedHtmlDumpFileName)
        {
            var context = new HtmlToWmlConverterContext(settings, emptyDocument);
        ...
        {
            int numId;
            NumberingUpdater.GetNextNumId(mainDocumentPart, out numId);
        ...
        private static void ConvertMainDocumentPart(XElement bodyxhtml, HtmlToWmlConverterContext context, string defaultCss, string authorCss, string userCss, string annotatedHtmlDumpFileName)
        {
            CssDocument defaultCssDoc, userCssDoc, authorCssDoc;
            bodyxhtml = PrepareForProcessing(bodyxhtml);
            CssApplier.ApplyAllCss(defaultCss, authorCss, userCss,
                bodyxhtml, context.ConversionSettings,
                out defaultCssDoc, out authorCssDoc, out userCssDoc,
...
@"<w:document xmlns:wpc='http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas'
            ...
            var documentPart = new OpenXMLDocumentPartWrapperForMainDocumentPart(context.WordDocument.MainDocumentPart);
            AnnotateOlUl(context.WordDocument.MainDocumentPart, bodyxhtml);
            XElement body = new XElement(W.body,
                        Transform(documentPart, bodyxhtml, context, NextExpected.Paragraph, false),
                        context.ConversionSettings.SectPr);

            var normalizedContent = cleanupTranformedHtml(context, ref body);
            xDoc.Root.Add(normalizedContent);
            StylesUpdater.UpdateStylesPart(context.WordDocument.MainDocumentPart, bodyxhtml, context.ConversionSettings, defaultCssDoc, userCssDoc, authorCssDoc);
            HtmlToWmlFontUpdater.UpdateFontsPart(context.WordDocument.MainDocumentPart, bodyxhtml, context.ConversionSettings);
            ThemeUpdater.UpdateThemePart(context.WordDocument.MainDocumentPart, bodyxhtml, context.ConversionSettings);
            NumberingUpdater.UpdateNumberingPart(context.WordDocument.MainDocumentPart, bodyxhtml, context.ConversionSettings);
        ...
        private static void ConvertHeaderFooterDocumentPart(int id, HeaderFooterContent headerfooterContent, HtmlToWmlConverterContext context, string defaultCss, string authorCss, string userCss)
        {
            ...
            CssApplier.ApplyAllCss(defaultCss, authorCss, userCss,
                xhtmlContent, context.ConversionSettings,
                out defaultCssDoc, out authorCssDoc, out userCssDoc, null);

            var allDocument = context.WordDocument.MainDocumentPart.GetXDocument();
            XDocument xDoc;
            IOpenXMLDocumentPartWrapper documentPart;
            XElement body;
            ...
            if (headerfooterContent.Type == HeaderFooterContentType.Header)
            {
                ...
                var headerDocumentPart = context.WordDocument.MainDocumentPart.AddNewPart<HeaderPart>("header" + id);
                newElementReferenceName = W.headerReference;
                newDocumentPart = headerDocumentPart;
                documentPart = new OpenXMLDocumentPartWrapperForHeaderPart(headerDocumentPart);
            }
            else
            {
                xDoc = XDocument.Parse(@"<?xml version='1.0' encoding='utf-8' standalone='yes'?>
				   <w:ftr xmlns:wpc='http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas'
						   ...
						   xmlns:wps='http://schemas.microsoft.com/office/word/2010/wordprocessingShape'
						   mc:Ignorable='w14 w15 wp14' />");
                var footerDocumentPart = context.WordDocument.MainDocumentPart.AddNewPart<FooterPart>("footer" + id);
                newElementReferenceName = W.footerReference;
                newDocumentPart = footerDocumentPart;
                documentPart = new OpenXMLDocumentPartWrapperForFooterPart(footerDocumentPart);
            }
            
            body = new XElement("dummy", Transform(documentPart, xhtmlContent, context, NextExpected.Paragraph, false));
            var normalizedContent = cleanupTranformedHtml(context, ref body);
            xDoc.Root.Add(normalizedContent.Elements());
            newDocumentPart.PutXDocument(xDoc);
            string newDocumentPartId = context.WordDocument.MainDocumentPart.GetIdOfPart(newDocumentPart);
        ...
        private static XElement cleanupTranformedHtml(HtmlToWmlConverterContext context, ref XElement body)
        {
        ...
        private static void AddNonBreakingSpacesForSpansWithWidth(HtmlToWmlConverterContext context, XElement body)
        {
            ...
            foreach (XElement run in runsWithWidth)
            {
                ...
                AdjustFontAttributes(context.WordDocument, run, pPr, rPr);
            ...
            if (element.Name == W.p && element.Elements().Any(c => c.Name == W.p || c.Name == W.tbl))
            {
                ...
                var newContent = groupedChildren
                    .Select(g =>
                    {
                        ...
                        return g.Select(n => NormalizeTransform(n)).ToList();
                    }).ToList();
                return newContent;
            }
            return new XElement(element.Name,
            ...
            if (element != null)
            {
                ...
                if (element.Name == XhtmlNoNamespace.a)
                {
                    ...
                    if (href != null)
                    {
                        ...
                        {
                            XElement rPr = GetRunProperties(element, context.ConversionSettings);
                ...
                {
                    nextExpected = GetNextExpected(node, nextExpected, context);
                ...
                if (element.Name == XhtmlNoNamespace.body
                    ...
                    || element.Name == XhtmlNoNamespace.sub
                    || element.Name == XhtmlNoNamespace.sup
                    || element.Name == XhtmlNoNamespace.s
                    || element.Name == XhtmlNoNamespace.b
                    || element.Name == XhtmlNoNamespace.strong 
                    || element.Name == XhtmlNoNamespace.bold
                    || element.Name == XhtmlNoNamespace.i
                    || element.Name == XhtmlNoNamespace.u
                    || element.Name == XhtmlNoNamespace.tt 
                    || element.Name == XhtmlNoNamespace.code 
                    || element.Name == XhtmlNoNamespace.kbd 
                    || element.Name == XhtmlNoNamespace.samp 
                    || element.Name == XhtmlNoNamespace.var)
                    return TransformRunElement(documentPart, element, context, preserveWhiteSpace);                    
                ...
                if (element.Name == XhtmlNoNamespace.td)
                {
                    ...
                    if (ElementHasBlockChildren(element, context))
                    {
                        ...
                        if (newElements.Last().Name != W.p)
                        {
                            ...
                            newElements.Add(new XElement(W.p, new XElement(W.pPr, tableTOC), new XElement(W.r)));
                        }
                    ...
                    {
                        var runProperties = GetRunProperties(element, context.ConversionSettings);
                ...
                object openXMLField = TransformOpenXMLCustomHtmlField(element, context, nextExpected);
                if (openXMLField != null)
                    return openXMLField;
        ...
        private static object TransformRunElement(IOpenXMLDocumentPartWrapper documentPart, XElement element, HtmlToWmlConverterContext context, bool preserveWhiteSpace)
        {
            ...
            //although these elements should do a run in some cases if their parent has block elements we might need to generate a paragraph - this code makes sure that if possible the paragraph will hold all children vs creating a paragraph for each child
            bool putChildrenInsideAParagraph = calculatedNextExpected == NextExpected.Paragraph && !hasBlockChildren;
            ...
            var firstChild = processedRunNodes.FirstOrDefault() as XElement;
            ...
            if (putChildrenInsideAParagraph)
                return new XElement(W.p, GetParagraphProperties(element, null, context.ConversionSettings), processedRunNodes);
            else
        ...
        private static NextExpected GetNextExpected(XNode element, NextExpected nextExpected, HtmlToWmlConverterContext context)
        {
            if (element == null)
                return nextExpected;
            else if (nextExpected == NextExpected.Paragraph || ElementHasBlockChildren(element.Parent != null ? element.Parent : element, context))
        ...
        private static bool ElementHasBlockChildren(XNode node, HtmlToWmlConverterContext context)
        {
            ...
            if (!context.cachedHasBlockChildren.TryGetValue(element, out elementHasBlockChildren))
            {
                elementHasBlockChildren = element.Elements().Any(d => !IsRun(d) || ElementHasBlockChildren(d, context));
                context.cachedHasBlockChildren[element] = elementHasBlockChildren;
            }
            return elementHasBlockChildren;
        }

        private static bool IsRun(XElement d)
        {
            return d.Name == XhtmlNoNamespace.span
                    || d.Name == XhtmlNoNamespace.strong || d.Name == XhtmlNoNamespace.b || d.Name == XhtmlNoNamespace.bold
        ...
        private static Dictionary<string, string> OpenXMLCustomHtmlFields = new Dictionary<string, string>()
        {
            { "currentpageno", "PAGE" },
        ...
        private static object TransformOpenXMLCustomHtmlField(XElement element, HtmlToWmlConverterContext context, NextExpected nextExpected)
        {
            ...
            if (GetNextExpected(element, nextExpected, context) == NextExpected.Paragraph)
            {
                hr.Add(GetParagraphProperties(element, null, context.ConversionSettings));
                return hr;
            }
            else
            {
                var elements = hr.Elements().ToList();
                elements[0].Add(GetRunProperties(element, context.ConversionSettings));
                return elements;
            }
        }
            ...
            string styleName, NextExpected nextExpected, bool preserveWhiteSpace)
        {
            if (nextExpected == NextExpected.Paragraph)
            {
                ...
                if (element != null)
                {
                    ...
                    if (leveledChildrenElements.Count == 0 || leveledChildrenElements[0].Name != W.p)
                        return new XElement(W.p, firstParagraphProperties, leveledChildrenElements);
                    else
                    {
                        var finalpPr = leveledChildrenElements[0].Elements().FirstOrDefault(e => e.Name == W.pPr);
                        if (finalpPr != null)
                        {
                            //update the first paragraph to have the parent and child properties - the paragraph properties are merged by adding the extra properties from the parent
                            var hash = finalpPr.Elements().ToDictionary(e => e.Name);
                            foreach (var prop in firstParagraphProperties.Elements().Where(e => !hash.ContainsKey(e.Name)))
                                finalpPr.Add(prop);
                            leveledChildrenElements[0] = new XElement(W.p, leveledChildrenElements[0].Elements());
                        }
                        else
                            leveledChildrenElements[0] = new XElement(W.p, firstParagraphProperties, leveledChildrenElements[0].Elements());
                        return leveledChildrenElements;
                    }
                }
                else
                {
                    ...
                    if (xTextNode != null)
                    {
                        ...
                        XElement p;
                        p = new XElement(W.p,
                            GetParagraphProperties(node.Parent, null, context.ConversionSettings),
                            new XElement(W.r,
                                GetRunProperties((XText)node, context.ConversionSettings),
                                new XElement(W.t,
            ...
            else
            {
                ...
                else if ((textNode = node as XText) != null)
                {
                    ...
                    XElement rPr = GetRunProperties(textNode, context.ConversionSettings);
        ...
        private static XElement TransformImageToWml(IOpenXMLDocumentPartWrapper documentPart, XElement element, HtmlToWmlConverterContext context)
        {
            ...
            if (pid == null)
            {
                ...
                context.WordDocument.AddAnnotation(pid);
            }
            ...
            string rId, string floatValue, int pictureId, string pictureDescription)
        {
            ...
            {
                Emu printWidth = (long)context.ConversionSettings.PageWidthEmus - (long)context.ConversionSettings.PageMarginLeftEmus - (long)context.ConversionSettings.PageMarginRightEmus;
        ...
        private static XElement GetRunProperties(XElement element, HtmlToWmlConverterSettings settings)
        {
            ...
            bool boldAncestor = element.AncestorsAndSelf(XhtmlNoNamespace.bold).Any();
            ...
            if (bAncestor || strongAncestor || boldAncestor || fontWeightString == "bold" || fontWeightString == "bolder" || fontWeightString == "600" || fontWeightString == "700" || fontWeightString == "800" || fontWeightString == "900")
            {
...
@"<w:tblCellMar xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>
  ...
  <w:right w:w='15'
    ...
    {
        public static void UpdateFontsPart(MainDocumentPart mainDocumentPart, XElement html, HtmlToWmlConverterSettings settings)
        {
            XDocument fontXDoc = mainDocumentPart.FontTablePart.GetXDocument();
...
@"<w:font w:name='Verdana' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>
  ...
  <w:sig w:usb0='A10006FF'
		  ...
		  w:csb1='00000000'/>
            ...
            mainDocumentPart.FontTablePart.PutXDocument();
        }
    }

    class NumberingUpdater
    {
        public static void InitializeNumberingPart(MainDocumentPart mainDocumentPart)
        {
            ...
            if (numberingPart == null)
            {
                ...
                mainDocumentPart.NumberingDefinitionsPart.PutXDocument(npXDoc);
            }
        }

        public static void GetNextNumId(MainDocumentPart mainDocumentPart, out int nextNumId)
        {
            InitializeNumberingPart(mainDocumentPart);
            NumberingDefinitionsPart numberingPart = mainDocumentPart.NumberingDefinitionsPart;
  ...
  <w:lvl w:ilvl='8' w:tentative='1'>
	...
	<w:rPr>
	  ...
	  <w:sz w:val='20' />
        ...
        public static void UpdateNumberingPart(MainDocumentPart mainDocumentPart, XElement html, HtmlToWmlConverterSettings settings)
        {
            InitializeNumberingPart(mainDocumentPart);
            NumberingDefinitionsPart numberingPart = mainDocumentPart.NumberingDefinitionsPart;
            XDocument numberingXDoc = numberingPart.GetXDocument();
            ...
            mainDocumentPart.NumberingDefinitionsPart.PutXDocument();
#if false
  <w:num w:numId='1'>
    ...
    class StylesUpdater
    {
        ...
        {
            XDocument styleXDoc = mainDocumentPart.StyleDefinitionsPart.GetXDocument();
...
@"<w:style w:type='character'
  ...
  <w:rPr>
	...
	<w:u w:val='single' />
            ...
            mainDocumentPart.StyleDefinitionsPart.PutXDocument();
        }
    }

    class ThemeUpdater
    {
        public static void UpdateThemePart(MainDocumentPart mainDocumentPart, XElement html, HtmlToWmlConverterSettings settings)
        {
            XDocument themeXDoc = mainDocumentPart.ThemePart.GetXDocument();
            ...
            mainDocumentPart.ThemePart.PutXDocument();
        }
    }
}
